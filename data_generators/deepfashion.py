...
import sys
sys.path.append('/home/tle19/Desktop/deeplab_torch/preprocessing/')
 ...
 #           print('in return')
    ...
    def transform_tr(self, sample):
        composed_transforms = transforms.Compose([
            ...
            RandomScaleCrop(base_size=self.config['image']['base_size'], crop_size=self.config['image']['crop_size']),
            RandomGaussianBlur(),
...
#            FixScaleCrop(crop_size=crop_size),
            FixScaleCrop(crop_size=self.config['image']['crop_size']),
